<%@ Page Title="" Language="C#" MasterPageFile="~/TFGMedMonitor.Master" AutoEventWireup="true" CodeBehind="CreateUser.aspx.cs" Inherits="Web.Pages.User.CreateUser" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder_BodyContent"
    ...
    <div id="form">
        <form id="RegisterForm" method="post" runat="server">
            ...
            <div class="field">
                <span class="label">
                    <asp:Localize ID="lclUserType" runat="server" meta:resourcekey="lclUserType" /></span><span
                        class="entry">
                        <asp:DropDownList ID="comboUserType" runat="server" Width="100px"
                            meta:resourcekey="comboUserTypeResource1">
                        </asp:DropDownList></span>
            </div>
            <div class="button">
